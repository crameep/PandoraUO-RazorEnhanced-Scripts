...
mineableTiles = [0x023a,0x023B,0x022C,0x023C,0x022D,0x022E,0x022F,0x00E4,0x00E6,0x00E5,0x00DC,0x00DE,0x00DD]#map art
...
def checkTile(x,y):
    ...
    if statics:
        Misc.SendMessage("Found Statics")
        for static in statics:
            Misc.SendMessage("Statics Found: {}".format(tile))
