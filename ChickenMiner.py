...
SerialAxe = 0x4050B74B # Serial Axe
ScanRange = 15
...
TreeStaticID = [0x245, 0x246, 0x247, 0x248, 0x249, 0x22b, 0x22c, 0x22d, 0x22e, 0x22f, 0x136D, 0x1367, 0x136A, 0x023B,0x022C,0x023C,0x022D,0x022E,0x022F,0x00E4,0x00E6,0x00E5,0x00DC,0x00DE,0x00DD,0x053E,0x053B,0x0540,0x0541,0x0542,0x0543,0x0544,0x0555,0x0546,0x0547,0x0548,0x0549]
EquipaxeDelay = 2000
            ...
            if tileinfo.Count > 0:
                for tile in tileinfo:
                    for staticid in TreeStaticID:
                        Misc.SendMessage(Statics.GetLandID(minx, miny, Player.Map), 222)
                        if staticid == tile.StaticID or staticid == Statics.GetLandID(minx, miny, Player.Map):
